...
description: "Add and tune animated liquid-metal WebGL borders with the React `metal-fx` package. Use when buttons, icon controls, chips, tabs, cards, or selected surfaces need a metallic active, selected,..."
license: MIT
...
metadata:
  upstream-repo: https://github.com/MengTo/Skills/tree/321c769739b823de5eb94eb3a52aa1974fe783a2/agent-skills/web-design/liquid-metal-border
  ...
  original-skill-sha256: 48cfbe4b4b529f62389a63167bfc8a781ffd778bc21772fffdae0cd06415b961
...
Run the project's lint, typecheck, production build, tests, and `git diff --check`. Then verify with an available browser or visual-rendering capability:
...
Report the installed `metal-fx` version, wrapped control, active-state source, preset, theme strategy, fallback border, reduced-motion behavior, build/test results, and browser or visual-rendering verification. Distinguish local readiness from a deployed result.
